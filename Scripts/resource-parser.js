...
☑️ 自用，修改自 ©𝐒𝐡𝐚𝐰𝐧 的最近版本，修改了对 Trojan 协议的转换  ⟦2021-12-18 14:31⟧
☑️ Trojan 类型 URL 转换成 QX 中读取 sni 改成 读取 peer
...
function TJ2QX(subs, Pudp, Ptfo, Pcert0, PTls13) {
    ...
    thost = cnt.indexOf("peer=") != -1? "tls-host="+cnt.split("peer=")[1].split(/&|#/)[0]:""
